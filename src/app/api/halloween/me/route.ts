...
import { z } from "zod";
import { parseAnswerDisplay } from "@/lib/halloween/answer-pattern";
import { currentQuizStep } from "@/lib/halloween/progress";
...
export async function GET(request: Request) {
  ...
  const claim = await prisma.halloweenClaim.findUnique({
